...
void CalcVertexRectangle(RectangleObject* rectangle) {
    ...
    rectangle->vertex.leftTop.x = rectangle->pos.x - rectangle->width * rectangle->scale.x / 2.0f;
    rectangle->vertex.leftTop.y = rectangle->pos.y + rectangle->height * rectangle->scale.y / 2.0f;
    rectangle->vertex.rightTop.x = rectangle->pos.x + rectangle->width * rectangle->scale.x / 2.0f;
    rectangle->vertex.rightTop.y = rectangle->pos.y + rectangle->height * rectangle->scale.y / 2.0f;
    rectangle->vertex.leftBottom.x = rectangle->pos.x - rectangle->width * rectangle->scale.x / 2.0f;
    rectangle->vertex.leftBottom.y = rectangle->pos.y - rectangle->height * rectangle->scale.y / 2.0f;
    rectangle->vertex.rightBottom.x = rectangle->pos.x + rectangle->width * rectangle->scale.x / 2.0f;
    rectangle->vertex.rightBottom.y = rectangle->pos.y - rectangle->height * rectangle->scale.y / 2.0f;
}
...
void ConvertWorldToScreenRectangle(RectangleObject* rectangle) {
    ...
    rectangle->screenVertex.leftBottom.y -= kWindowHeight;
    rectangle->screenVertex.leftBottom.y *= -1.0f;
...
void ConvertUnitPixelToMapRectangle(RectangleObject* rectangle) {
    ...
    rectangle->mapVertex.leftBottom.x = static_cast<int>(rectangle->screenVertex.leftBottom.x / 50.0f);
    rectangle->mapVertex.leftBottom.y = static_cast<int>(rectangle->screenVertex.leftBottom.y / 50.0f);
